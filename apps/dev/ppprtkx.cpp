                              ...
                              int   precision )
{
   ...
   if( useNEU )
   {
      ...
      outfile << solver.getSolution(TypeID::wetMap) << "  ";
                                                                 // ztd - #7
      ...
      outfile << solver.getFixedSolution(TypeID::wetMap) << "  "; // ztd - #15
...
//    deltaCorr.setInterpType(TypeID::ionoL1);
