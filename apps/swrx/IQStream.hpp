...
#pragma clang diagnostic pop
      ...
      virtual void readComplex(std::complex<double>& v) = 0;

      /// Writes a single complex sample, 
      virtual void writeComplex(const std::complex<short>& v) = 0;
      virtual void writeComplex(const std::complex<double>& v) = 0;
   }; // class IQStream
   ...
   inline IQStream& operator>>(IQStream& s, std::complex<double>& v)
   { s.readComplex(v); return s; };
   ...
   public:
      ...
      virtual void readComplex(std::complex<double>& v);

      /// Writes a single complex sample, 
      virtual void writeComplex(const std::complex<short>& v);
      virtual void writeComplex(const std::complex<double>& v);
   }; // class IQ1Stream
