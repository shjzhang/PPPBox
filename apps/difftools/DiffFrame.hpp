...
public:
   ...
   DiffFrame(char* arg0, 
      ...
      : gpstk::BasicFramework(arg0,
        ...
        typeOption('t', "type", "[-t|--type] Observation type to print",
                     false),
        filterOption('f', "filter", "A switch to filter values which equal 0 with no argument")
   {
...
#pragma clang diagnostic ignored "-Woverloaded-virtual"
   virtual bool initialize(int argc, char* argv[]) throw()
   {
      ...
      if (typeOption.getCount())
      {
         string type = typeOption.getValue()[0];
      }
...
protected:
   ...
   gpstk::CommandOptionNoArg filterOption;
};
