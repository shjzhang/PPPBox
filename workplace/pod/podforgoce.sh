...
#get_eph.sh -b "2009 11 25 0 0 0" -e "2009 11 27 0 0 0" -i 24 -a "IGS" -u "url.list" -t "type.list" -l "$proj" -p " /Users/whusgghwei/Desktop/Daily_Mac/gpstk_data/IGS/data" > get_eph.log
...
podforgoce -r $proj.rnxlist -s $proj.ephlist -k $proj.clklist -e $proj.erplist -m msc.txt -o $proj.outlist
