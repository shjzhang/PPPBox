#pragma ident "$Id: DatumPPP.cpp 2939 2012-04-06 19:55:11Z shjzhang $"
...
//  2012/10/20  Change this file name from "AmbDatumPos" to "DatumPPP" 
//
//============================================================================
...
namespace gpstk
{
   ...
   WhiteNoiseModel DatumPPP::whiteNoiseModel;
       ...
       *                  by SourceID.
       */
   DatumPPP& DatumPPP::Prepare( gnssRinex& gData )
   {
   ...
   }  // End of method 'DatumPPP::Prepare()'


      /** 
       * Get the ambiguity datum set which are fixed directly.
       */
   std::map<SatID,double> DatumPPP::getAmbFixedMap( void )
      throw(InvalidDatumPPP)
   {
      ...
      if (!isPrepared)
      {
         GPSTK_THROW(InvalidDatumPPP("DatumPPP is not prepared"));
      }

         // Return
      return ambFixedMap;

   }  // End of method 'DatumPPP::getAmbFixedMap()'
