...
#ifndef GPSTK_RINEX_UPD_STORE_INCLUDE
#define GPSTK_RINEX_UPD_STORE_INCLUDE
...
namespace gpstk
{
       ...
       *
       */
   class RinexUPDStore : public TabularSatStore<SatUPD>
   {
   public:
      ...
      RinexUPDStore() {};
          ...
          *
          */
      virtual SatUPD getValue(const SatID& sat, const CommonTime& ttag)
      ...
      {
         os << " Dump of RinexUPDStore(" << detail << "):\n";

         os << " Interpolation is ";
         os << " Linear." << std::endl;

            // dump  the satellite upd data
         TabularSatStore<SatUPD>::dump(os,detail);

         os << " End dump of RinexUPDStore.\n";
      }

         /** Add a complete SatUPD to the store; this is the preferred method
          ...
          *
          */
      void addSatUPD(const SatID& sat, 
   ...
   protected:
      ...
      FileStore<RinexUPDHeader> clkFiles;

   }; // end class RinexUPDStore

      //@}

}  // End of namespace gpstk

#endif // GPSTK_RINEX_UPD_STORE_INCLUDE
