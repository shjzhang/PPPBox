#pragma ident "$Id: SolverGeneral.cpp 2877 2011-08-20 08:40:11Z yanweignss $"
...
namespace gpstk
{
      ...
      throw(ProcessingException)
   {
      ...
      //
   gnssDataMap& SolverGeneral::Compute( gnssDataMap& gdsMap )
      throw(InvalidSolver)
   {
      ...
      // @param gData    Data object holding the data.
      //
   int SolverGeneral::TimeUpdate( const Matrix<double>& phiMatrix,
...
of qMatrix");
      ...
      // @param gData    Data object holding the data.
      //
   int SolverGeneral::MeasUpdate( const Vector<double>& prefitResiduals,
...
matrix and a priori state estimation vector do not match.");
   ...
   }  // End of method 'SolverGeneral::MeasUpdate()'
