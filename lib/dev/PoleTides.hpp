...
namespace gpstk
{
   ...
   public:
      ...
      PoleTides() : xdisp(0.0), ydisp(0.0), pEOPStore(NULL) {};
      ...
      PoleTides( const double& x,
                 const double& y )
         : xdisp(x), ydisp(y), pEOPStore(NULL) {};
          ...
          * @param y     Pole displacement y, in arcseconds
          */
      PoleTides( EOPDataStore& eopDataStore )
         : pEOPStore(&eopDataStore) {};
   ...
   private:
      ...
      double ydisp;
         ...
         /// Object that store earth orientation parameter file
