#pragma ident "$Id: DatumPPPWL.hpp 2583 2012-06-09 01:26:05Z shjzhang $" 
...
#ifndef GPSTK_DATUMPPPWL_HPP
#define GPSTK_DATUMPPPWL_HPP
...
namespace gpstk
{
      ...
      /// Thrown when attempting to use an invalid DatumPPPWL
      /// @ingroup exceptiongroup
   NEW_EXCEPTION_CLASS(InvalidDatumPPPWL, gpstk::Exception);
       ...
       *
       * In order to achieve this, the 'DatumPPPWL' class will start from a
   ...
   public:
      ...
      {};
          ...
          */
      virtual DatumPPPWL& Prepare(gnssRinex& gData);
   ...
   private :
      ...
      Arc newArc;
         ...
         /// Whether or not this DatumPPPWL is ready to be used
      bool firstTime;
