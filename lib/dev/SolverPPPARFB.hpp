#pragma ident "$Id: SolverPPPARFB.hpp 1914 2009-05-24 22:09:30Z architest $"

/**
 * @file SolverPPPARFB.hpp
 * Class to compute the PPP solution in forwards-backwards mode.
 */

#ifndef GPSTK_SOLVERPPPARFB_HPP
#define GPSTK_SOLVERPPPARFB_HPP
...
namespace gpstk
{
       ...
       *
       * In reality, "SolverPPPARFB.hpp" objects are really "SolverPPP.hpp"
       ...
       *
       * In order to achieve this, SolverPPPARFB.hpp" objects work in three
       * distinct phases:
       *
       ...
       *        final results.
       *
       * Take due note that the "SolverPPPARFB.hpp" class is designed to be used
       ...
       *
       *      // Declare a SolverPPPARFB object
       *   SolverPPPARFB pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPPARFB" object will also insert back postfit residual data
       ...
       *
       * In any case, the "SolverPPPARFB" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPPARFB" object will
       ...
       * @endcode
       *
       * \warning "SolverPPPARFB" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPPARFB : public SolverPPPAR
   {
   public:
          ...
          */
      SolverPPPARFB(bool useNEU = false);
      ...
      { return limitsCodeList; };
          ...
          */
      virtual SolverPPPARFB& setCodeList( std::list<double> codeList )
      ...
      { return limitsPhaseList; };
          ...
          * \warning Limits will be applied in the same order they were added.
          */
      virtual SolverPPPARFB& setPhaseList( std::list<double> phaseList )
      ...
      { return rejectedMeasurements; };
          ...
          */
      virtual SolverPPPARFB& setCoordinatesModel(StochasticModel* pModel)
      { SolverPPPAR::setCoordinatesModel(pModel); return (*this); };
          ...
          *
          */
      virtual SolverPPPARFB& setNEU( bool useNEU );
