#pragma ident "$Id: SolverPPPUCARFB.cpp 2346 2010-03-13 15:55:58Z yanweignss $"

/**
 * @file SolverPPPUCARFB.cpp
...
namespace gpstk
{
   ...
   int SolverPPPUCARFB::classIndex = 9400000;


      // Returns an index identifying this object.
   int SolverPPPUCARFB::getIndex() const
   { return index; }


      // Returns a string identifying this object.
   std::string SolverPPPUCARFB::getClassName() const
   { return "SolverPPPUCARFB"; }
       ...
       */
   SolverPPPUCARFB::SolverPPPUCARFB(bool useNEU)
      : SolverPPPUCAR(useNEU), firstIteration(true)
   {
      ...
      keepTypeSet.insert(TypeID::BL2);    // #4
         ...
         // Observables
      keepTypeSet.insert(TypeID::prefitC1);
      keepTypeSet.insert(TypeID::prefitP1);
      keepTypeSet.insert(TypeID::prefitP2);
      keepTypeSet.insert(TypeID::prefitL1);
      keepTypeSet.insert(TypeID::prefitL2);
   ...
   }  // End of 'SolverPPPUCARFB::SolverPPPUCARFB()'
       ...
       */
   gnssSatTypeValue& SolverPPPUCARFB::Process(gnssSatTypeValue& gData)
      throw(ProcessingException, SVNumException)
   {
   ...
   }  // End of method 'SolverPPPUCARFB::Process()'
       ...
       * @param gData     Data object holding the data.
       */
   gnssRinex& SolverPPPUCARFB::Process(gnssRinex& gData)
      throw(ProcessingException, SVNumException)
   {
       ...
       */
   void SolverPPPUCARFB::ReProcess(int cycles)
      throw(ProcessingException, SVNumException)
   {
   ...
   }  // End of method 'SolverPPPUCARFB::ReProcess()'
       ...
       * limitsPhaseList.
       */
   void SolverPPPUCARFB::ReProcess( void )
      throw(ProcessingException, SVNumException)
   {
       ...
       */
   bool SolverPPPUCARFB::LastProcess(gnssSatTypeValue& gData)
      throw(ProcessingException, SVNumException)
   {
   ...
   }  // End of method 'SolverPPPUCARFB::LastProcess()'
       ...
       * @return FALSE when all data is processed, TRUE otherwise.
       */
   bool SolverPPPUCARFB::LastProcess(gnssRinex& gData)
      throw(ProcessingException, SVNumException)
   {
      ...
      try
      {
         ...
         if( !(ObsData.empty()) )
         {
            ...
            gData = SolverPPPUCAR::Process( ObsData.front() );
            ...
            solution = SolverPPPUCAR::solution;
            covMatrix = SolverPPPUCAR::covMatrix;
            postfitResiduals = SolverPPPUCAR::postfitResiduals;
   ...
   void SolverPPPUCARFB::checkLimits( gnssRinex& gData,
                                  double codeLimit,
                                  double phaseLimit )
   {
   ...
   }  // End of method 'SolverPPPUCARFB::checkLimits()'
       ...
       *
       */
   SolverPPPUCARFB& SolverPPPUCARFB::setNEU( bool useNEU )
   {
   ...
   }  // End of method 'SolverPPPUCARFB::setNEU()'
