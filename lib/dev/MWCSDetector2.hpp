...
/**
 * @file MWCSDetector2.hpp
 * This is a class to detect cycle slips using the Melbourne-Wubbena
 * combination.
 */

#ifndef GPSTK_MWCSDETECTOR2_HPP
#define GPSTK_MWCSDETECTOR2_HPP
...
namespace gpstk
{
       ...
       * @endcode
       *
       * The "MWCSDetector2" object will visit every satellite in the GNSS data
       ...
       *
       */
      class MWCSDetector2 : public ProcessingClass
      {
      public:
            
            /// Default constructor, setting default parameters.
            MWCSDetector2() : obsType(TypeID::MWubbena), lliType1(TypeID::LLI1),
             ...
             */
            MWCSDetector2( const double& mLambdas,
             ...
             */
            virtual MWCSDetector2& setDeltaTMax(const double& maxDelta);
             ...
             *                     wavelenghts).
             */
            virtual MWCSDetector2& setMaxNumLambdas(const double& mLambdas);
             ...
             */
            virtual MWCSDetector2& setUseLLI(const bool& use)
      ...
      }; // End of class 'MWCSDetector2'
      
      //@}
      
}  // End of namespace gpstk

#endif   // GPSTK_MWCSDETECTOR2_HPP
