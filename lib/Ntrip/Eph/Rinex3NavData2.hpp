...
namespace gpstk
{
   ...
   class Rinex3NavData2 : public Rinex3NavBase
   {
   public:
         /** Constructor
      ...
      Rinex3NavData2(const GloEphemeris& gloe);

         /// Create from a RinexNavData (for backward compatibility)
      Rinex3NavData2(const RinexNavData& rnd);

         /// Initializes the nav data with an EngEphemeris
         /// EngEphemeris is deprecated; use GPSEphemeris2
      Rinex3NavData2(const EngEphemeris& ee);

         /// Initializes the nav data with a GPSEphemeris2
      Rinex3NavData2(const GPSEphemeris2& gpseph);

         /// Initializes the nav data with a GalEphemeris
      Rinex3NavData2(const GalEphemeris& galeph);

         /// Initializes the nav data with a BDSEphemeris
      Rinex3NavData2(const BDSEphemeris& bdseph);

         /// Initializes the nav data with a QZSEphemeris
      Rinex3NavData2(const QZSEphemeris& qzseph);

         /// Destructor
      virtual ~Rinex3NavData2() {}

         /// Rinex3NavData2 is "data" so this function always returns true.
      ...
      virtual void dump(std::ostream& s) const;
         ...
         /// deprecated; use GPSEphemeris2, GPS-only.
         /// Converts Rinex3NavData2 to an EngEphemeris object.
      operator EngEphemeris() const throw();

         /// Converts Rinex3NavData2 to a GPSEphemeris2 object.
      operator GPSEphemeris2() const throw();

         /// Converts this Rinex3NavData2 to a GloEphemeris object.
      operator GloEphemeris() const throw();

         /// Converts Rinex3NavData2 to a GalEphemeris object.
      operator GalEphemeris() const throw();

         /// Converts Rinex3NavData2 to a BDSEphemeris object.
      operator BDSEphemeris() const throw();

         /// Converts Rinex3NavData2 to a QZSEphemeris object.
      ...
      bool operator<(const Rinex3NavData2& right) const
      {
   ...
   private:
      ...
      void putRecord(const int& n, Rinex3NavStream& strm) const
         ...
         /// Helper routine for constructors of this from OrbitEph2-based Ephemerides
      void loadFrom(const OrbitEph2 *oeptr);

         /// Helper routine for casts from this to OrbitEph2-based Ephemerides
      void castTo(OrbitEph2 *oeptr) const;
