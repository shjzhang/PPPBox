/// @file GPSEphemeris2.hpp Encapsulates the GPS legacy broadcast ephemeris and clock.
...
#ifndef GPSTK_GPSOrbitEph2_HPP
#define GPSTK_GPSOrbitEph2_HPP
...
namespace gpstk
{
   class GPSEphemeris2 : public OrbitEph2
   {
   public:
	   /// Default constuctor
      GPSEphemeris2(void)
      ...
      virtual std::string getName(void) const
         { return std::string("GPSEphemeris2"); }
   ...
   }; // end class GPSEphemeris2

   //@}
   
} // end namespace

#endif // GPSTK_GPSOrbitEph2_HPP
