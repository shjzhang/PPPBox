...
/**
 * @file EclipsedSatMarker.hpp
 * This class filters out satellites that are eclipsed by Earth shadow.
 */

#ifndef GPSTK_ECLIPSEDSATMARKER_HPP
#define GPSTK_ECLIPSEDSATMARKER_HPP
...
//
//  Shjzhang, Wuhan University, 2015/07/24
//
//============================================================================
...
namespace gpstk
{
      ...
      /** This class will mark satellites that are eclipsed by Earth shadow.
       *
       ...
       * @endcode
       *
       * The "EclipsedSatMarker" object will visit every satellite in the GNSS
       ...
       *
       */
   class EclipsedSatMarker : public ProcessingClass
   {
      public:

         /// Default constructor.
      EclipsedSatMarker() : coneAngle(30.0), postShadowPeriod(1800.0)
      { };
          ...
          */
      EclipsedSatMarker( const double angle,
      ...
      { return coneAngle; };
          ...
          */
      virtual EclipsedSatMarker& setConeAngle(const double angle);
      ...
      { return postShadowPeriod; };
          ...
          *                   still be filtered out, in seconds.
          */
      virtual EclipsedSatMarker& setPostShadowPeriod(const double pShTime);
   ...
   }; // End of class 'EclipsedSatMarker'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_ECLIPSEDSATMARKER_HPP
