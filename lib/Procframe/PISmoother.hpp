...
#ifndef GPSTK_PISMOOTHER_HPP
#define GPSTK_PISMOOTHER_HPP
...
namespace gpstk
{
      ...
      /** This class smoothes the PI (ionosphere-free) code observable using
       * the corresponding LI phase observable.
       *
       ...
       *   while(rin >> gRin)
       *   {
       *      gRin >> markCSL1 >> smoothPI;
       *   }
       * @endcode
       *
       * The "PISmoother" object will visit every satellite in the GNSS data
       * structure that is "gRin" and will smooth the PI code observation using
       * the corresponding LI phase observation.
       *
       ...
       * data structure with the PI code observation smoothed (unless the
       ...
       * data sampled at 1 Hz. Note that the PI observable doesn't suffer the
       ...
       *
       */
   class PISmoother : public CodeSmoother
   {
   public:

         /// Default constructor, setting default parameters and PI and LI
         /// as observables.
      PISmoother() : codeType(TypeID::PI), phaseType(TypeID::LI),
         resultType(TypeID::PI), maxWindowSize(100), csFlag1(TypeID::CSL1),
         csFlag2(TypeID::CSL2)
      { };
          ...
          */
      PISmoother( const int& mwSize,
                  const TypeID& resultT = TypeID::PI )
         : codeType(TypeID::PI), phaseType(TypeID::LI), resultType(resultT),
      ...
      { return resultType; };
          ...
          */
      virtual PISmoother& setResultType(const TypeID& resultT)
      ...
      { return maxWindowSize; };
          ...
          */
      virtual PISmoother& setMaxWindowSize(const int& maxSize);
      ...
      { return csFlag1; };
          ...
          */
      virtual PISmoother& setCSFlag1(const TypeID& csT)
      ...
      { return csFlag2; };
          ...
          * @param csT   Cycle slip type to be used
          */
      virtual PISmoother& setCSFlag2(const TypeID& csT)
...
#pragma clang diagnostic pop
      ...
      virtual PISmoother& setCodeType(const TypeID& dummy)
      { return (*this); };

         /// This method is out of reach in this class.
      virtual PISmoother& setPhaseType(const TypeID& dummy)
      { return (*this); };

         /// This method is out of reach in this class.
      virtual PISmoother& setCSFlag(const TypeID& dummy)
      { return (*this); };
   ...
   }; // End of class 'PISmoother'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_PISMOOTHER_HPP
