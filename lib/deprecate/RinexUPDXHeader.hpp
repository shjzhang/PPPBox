#pragma ident "$Id: RinexUPDXHeader.hpp 2897 2012-08-10 20:08:46Z shjzhang $"

/**
 * @file RinexUPDXHeader.hpp
...
#ifndef GPSTK_RINEX_UPDX_HEADER_HPP
#define GPSTK_RINEX_UPDX_HEADER_HPP
...
namespace gpstk
{
   ...
   //@{
       ...
       *  rinex clock file.
       *
       * @sa gpstk::RinexUPDXStream and gpstk::RinexUPDXData for more information.
       */
   class RinexUPDXHeader : public RinexUPDXBase
   {
   ...
   public:
      ...
      {}
         ...
         /**
          * @name RinexUPDXHeaderFormatStrings
      ...
      enum validBits
      {
         ...
         /// destructor
      virtual ~RinexUPDXHeader() {}


         // The next four lines is our common interface
         /// RinexUPDXHeader is a "header" so this function always returns true.
      ...
      double version;                              ///< Satellite UPDX Version or file format
   ...
   }; // end class RinexUPDXHeader

   //@}

}  // namespace

#endif // GPSTK_RINEX_UPDX_HEADER_HPP
