#pragma ident "$Id: SolverPPPX2.hpp 2645 2011-06-08 03:23:24Z shjzhang $"

/**
 * @file SolverPPPX2.hpp
 * Class to compute the PPP Solution with ionospheric estimation.
 */

#ifndef GPSTK_SOLVERPPPX2_HPP
#define GPSTK_SOLVERPPPX2_HPP
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverPPPX2 object
       *   SolverPPPX2 pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPPX2" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverPPPX2" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPPX2" object will
       ...
       *
       *
       * \warning "SolverPPPX2" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPPX2 : public CodeKalmanSolver
   {
   public:
          ...
          */
      SolverPPPX2(bool useNEU = false, bool fixPos = false);
      ...
      virtual gnssRinex& Process(gnssRinex& gData)
          ...
          *
          */
      virtual SolverPPPX2& setNEU( bool useNEU );
          ...
          */
      virtual SolverPPPX2& setFixCoordinate( bool fixPos );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverPPPX2& setCoordinatesModel(StochasticModel* pModel);
   ...
   private:
      ...
      virtual SolverPPPX2& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverPPPX2'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERPPPX2_HPP
