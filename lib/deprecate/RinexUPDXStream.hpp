#pragma ident "$Id: RinexUPDXStream.hpp 2635 2012-08-12 12:56:47Z shjzhang $"

/**
 * @file RinexUPDXStream.hpp
 * gpstk::RinexUPDXStream - Satellite bias file stream
 */

#ifndef GPSTK_RINEX_UPDX_STREAM_INCLUDE
#define GPSTK_RINEX_UPDX_STREAM_INCLUDE
...
namespace gpstk
{
   ...
   //@{
        ...
        */
   class RinexUPDXStream : public FFTextStream
   {
   public:
      ...
      {}
          ...
          *
          */
      RinexUPDXStream(const char* filename, std::ios::openmode mode=std::ios::in) 
      ...
      virtual ~RinexUPDXStream() { }


         /// true if the header has been read
      bool headerRead;             

   }; // class RinexUPDXStream
   
   //@}
   
} // namespace gpstk

#endif // GPSTK_RINEX_UPDX_STREAM_INCLUDE
