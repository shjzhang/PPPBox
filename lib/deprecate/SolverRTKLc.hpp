#pragma ident "$Id: SolverRTKLc.hpp 2645 2011-06-08 03:23:24Z shjzhang $"

/**
 * @file SolverRTKLc.hpp
 * Class to compute the PPP Solution with ionospheric estimation.
 */

#ifndef GPSTK_SOLVERRTKLC_HPP
#define GPSTK_SOLVERRTKLC_HPP
...
//  Revision
//
//  2015/01/28  PPP-RTK test with  observations
//
//============================================================================
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverRTKLc object
       *   SolverRTKLc pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverRTKLc" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverRTKLc" object will also automatically add and
       * estimate the B1/B2/B ambiguities. The independent vector
       ...
       *
       * If these weights are not assigned, then the "SolverRTKLc" object will
       ...
       *
       *
       * \warning "SolverRTKLc" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverRTKLc : public CodeKalmanSolver
   {
   public:
      ...
      virtual void AmbiguityUpdate(Vector<double>& state,
          ...
          *
          */
      virtual SolverRTKLc& setNEU( bool useNEU );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverRTKLc& setCoordinatesModel(StochasticModel* pModel);
          ...
          *
          */
      SolverRTKLc& setFixWithLambda(bool useLambda )
   ...
   private:
      ...
      StochasticModel* pAmbiModel; // for L1 ambiguity
      ...
      virtual SolverRTKLc& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverRTKLc'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_SOLVERRTKLC_HPP
