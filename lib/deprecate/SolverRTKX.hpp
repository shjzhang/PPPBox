#pragma ident "$Id: SolverRTKX.hpp 2645 2011-06-08 03:23:24Z shjzhang $"
...
#ifndef GPSTK_SOLVERRTKX_HPP
#define GPSTK_SOLVERRTKX_HPP
...
namespace gpstk
{
       ...
       *  P1/L1/Pdelta/Ldelta combinations.
       *
       ...
       *
       *      // Declare a SolverRTKX object
       *   SolverRTKX pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverRTKX" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverRTKX" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverRTKX" object will
       ...
       *
       *
       * \warning "SolverRTKX" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverRTKX : public CodeKalmanSolver
   {
   public:
      ...
      virtual void AmbiguityUpdate(Vector<double>& state,
          ...
          *
          */
      virtual SolverRTKX& setNEU( bool useNEU );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverRTKX& setCoordinatesModel(StochasticModel* pModel);
          ...
          *
          */
      virtual SolverRTKX& setIonosphericModel(StochasticModel* pModel);
          ...
          */
      SolverRTKX& setInitialTropVar(double variance)
      { initialTropVar = variance; return (*this); };
          ...
          * @param variance      Initial variance assigned to this variable.
          */
      SolverRTKX& setInitialIonoVar(double variance)
   ...
   private:
      ...
      virtual SolverRTKX& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverRTKX'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERRTKX_HPP
