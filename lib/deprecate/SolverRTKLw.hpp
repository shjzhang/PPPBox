#pragma ident "$Id: SolverRTKLw.hpp 2645 2011-06-08 03:23:24Z shjzhang $"

/**
 * @file SolverRTKLw.hpp
 * Class to compute the PPP Solution with ionospheric estimation.
 */

#ifndef GPSTK_SOLVERRTKLW_HPP
#define GPSTK_SOLVERRTKLW_HPP
...
//  Revision
//
//  2015/01/28  PPP-RTK test with WL observations
//
//============================================================================
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverRTKLw object
       *   SolverRTKLw pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverRTKLw" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverRTKLw" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverRTKLw" object will
       ...
       *
       *
       * \warning "SolverRTKLw" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverRTKLw : public CodeKalmanSolver
   {
   public:
      ...
      virtual void AmbiguityUpdate(Vector<double>& state,
          ...
          *
          */
      virtual SolverRTKLw& setNEU( bool useNEU );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverRTKLw& setCoordinatesModel(StochasticModel* pModel);
          ...
          *
          */
      SolverRTKLw& setFixWithLambda(bool useLambda )
   ...
   private:
      ...
      virtual SolverRTKLw& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverRTKLw'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_SOLVERRTKLW_HPP
