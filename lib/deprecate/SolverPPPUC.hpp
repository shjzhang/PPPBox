#pragma ident "$Id: SolverPPPUC.hpp 2645 2011-06-08 03:23:24Z shjzhang $"
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverPPPUC object
       *   SolverPPPUC pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPPUC" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverPPPUC" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPPUC" object will
       ...
       *
       *
       * \warning "SolverPPPUC" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPPUC : public CodeKalmanSolver
   {
   public:
          ...
          */
      SolverPPPUC(bool useNEU = false, bool fixPos = false);
      ...
      virtual gnssRinex& Process(gnssRinex& gData)
          ...
          *
          */
      virtual SolverPPPUC& setNEU( bool useNEU );
          ...
          */
      virtual SolverPPPUC& setFixCoordinate( bool fixPos );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverPPPUC& setCoordinatesModel(StochasticModel* pModel);
   ...
   private:
      ...
      virtual SolverPPPUC& setDefaultEqDefinition(
