#pragma ident "$Id: RinexUPDXHeader.cpp 2897 2011-09-14 20:08:46Z shjzhang $"

/**
 * @file RinexUPDXHeader.cpp
...
namespace gpstk
{
   ...
   const string RinexUPDXHeader::versionString =        "RINEX VERSION / TYPE";
   const string RinexUPDXHeader::runByString =          "PGM / RUN BY / DATE";
   const string RinexUPDXHeader::commentString =        "COMMENT";
   const string RinexUPDXHeader::sysString =            "SYS / # / OBS TYPES";
   const string RinexUPDXHeader::timeSystemString =     "TIME SYSTEM ID";
   const string RinexUPDXHeader::leapSecondsString =    "LEAP SECONDS";
   const string RinexUPDXHeader::sysDCBString =         "SYS / DCBS APPLIED";
   const string RinexUPDXHeader::sysPCVString =         "SYS / PCVS APPLIED";
   const string RinexUPDXHeader::numDataString =        "# / TYPES OF DATA";
   const string RinexUPDXHeader::stationNameString =    "STATION NAME / NUM";
   const string RinexUPDXHeader::stationClockRefString ="STATION CLK REF";
   const string RinexUPDXHeader::analysisCenterString = "ANALYSIS CENTER";
   const string RinexUPDXHeader::numClockRefString =    "# OF CLK REF";
   const string RinexUPDXHeader::analysisClkRefrString ="ANALYSIS CLK REF";
   const string RinexUPDXHeader::numReceiversString =   "# OF SOLN STA / TRF";
   const string RinexUPDXHeader::solnStateString =      "SOLN STA NAME / NUM";
   const string RinexUPDXHeader::numSolnSatsString =    "# OF SOLN SATS";
   const string RinexUPDXHeader::prnListString =        "PRN LIST";
   const string RinexUPDXHeader::endOfHeaderString =    "END OF HEADER";


      // Get the record from the satellite upd file
   void RinexUPDXHeader::reallyGetRecord(FFStream& ffs)
      throw(exception, FFStreamError, StringException)
   {
      ...
      while(!(valid & endOfHeaderValid)) 
      {
         ...
         if(debug) 
         {
            cout << "RinexUPDX Header Line " << line << endl;
         }
   ...
   }  // end RinexUPDXHeader::reallyGetRecord()


   void RinexUPDXHeader::reallyPutRecord(FFStream& ffs) const
      throw(exception, FFStreamError, StringException)
   {
      try 
      {
   ...
   void RinexUPDXHeader::dump(ostream& os, short detail) const throw()
   {
      int i;
      os << "Dump RinexUPDX Header:\n";
      ...
      os << "End of RinexUPDX header dump." << endl;

   }  // end RinexUPDXHeader::dump()

   void RinexUPDXHeader::dumpValid(ostream& os) const throw()
   {
