#pragma ident "$Id: SolverRTKX2.cpp 2645 2012-11-05 03:23:24Z shjzhang $"

/**
 * @file SolverRTKX2.cpp
...
namespace gpstk
{
   ...
   int SolverRTKX2::classIndex = 9300000;


      // Returns an index identifying this object.
   int SolverRTKX2::getIndex() const
   { return index; }


      // Returns a string identifying this object.
   std::string SolverRTKX2::getClassName() const
   { return "SolverRTKX2"; }
       ...
       */
   SolverRTKX2::SolverRTKX2(bool useNEU)
   ...
   }  // End of 'SolverRTKX2::SolverRTKX2()'



      // Initializing method.
   void SolverRTKX2::Init(void)
   {
   ...
   }  // End of method 'SolverRTKX2::Init()'
       ...
       */
   gnssSatTypeValue& SolverRTKX2::Process(gnssSatTypeValue& gData)
      throw(ProcessingException, SVNumException)
   {
   ...
   }  // End of method 'SolverRTKX2::Process()'
       ...
       * @param gData     Data object holding the data.
       */
   gnssRinex& SolverRTKX2::Process(gnssRinex& gData)
      throw(ProcessingException, SVNumException)
   {
       ...
       * @param gData    Data object holding the data.
       */
   gnssRinex& SolverRTKX2::preCompute( gnssRinex& gData )
      throw(ProcessingException, SVNumException)
   {
...
//       }
         ...
         for( int i=0; i<numCurrentSV; i++ )
         {
            ...
            measVector( i + 2*numCurrentSV ) = prefitL(i);
         ...
         for( int i=0; i<numCurrentSV; i++ )
         {
            ...
            hMatrix( i                 , 4 ) = 1.0; // PC
            hMatrix( i +   numCurrentSV, 4 ) = 1.0; // Pdelta
            hMatrix( i + 2*numCurrentSV, 5 ) = 1.0; // LC
         ...
         for( int i=0; i<numCurrentSV; i++ )
         {
            ...
            hMatrix( i + 2*numCurrentSV, numVar +   numCurrentSV + i ) 
                = -0.106953378142;
            hMatrix( i + 2*numCurrentSV, numVar + 2*numCurrentSV + i ) 
                = -0.377482511089;
   ...
   }  // End of method 'SolverRTKX2::preCompute()'
      ...
      //
   gnssRinex& SolverRTKX2::Compute( gnssRinex& gData )
      throw(InvalidSolver)
   {
   ...
   }  // End of method 'SolverRTKX2::Compute()'
      ...
      // @param gData    Data object holding the data.
      //
   int SolverRTKX2::TimeUpdate( const Matrix<double>& phiMatrix,
...
of qMatrix");
   ...
   }  // End of method 'SolverRTKX2::TimeUpdate()'


   gnssRinex& SolverRTKX2::AmbiguityConstr( gnssRinex& gData )
   ...
   }  // End of method 'SolverRTKX2::AmbiguityConstr()'



      // Now, fix all the ambiguities to integers 
   gnssRinex& SolverRTKX2::AmbiguityFixing( gnssRinex& gData )
      throw(ProcessingException)
   {
...
//       covMatrix = newCov;
   ...
   }  // End of method 'SolverRTKX2::AmbiguityFixing()'
       ...
       */
   void SolverRTKX2::AmbiguityUpdate( Vector<double>& state,
      ...
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverRTKX2::AmbiguityUpdate()'
      ...
      // @param gData    Data object holding the data.
      //
   int SolverRTKX2::MeasUpdate( const Vector<double>& prefitResiduals,
...
matrix and a priori state estimation vector do not match.");
   ...
   }  // End of method 'SolverRTKX2::MeasUpdate()'
       ...
       * @param gData    Data object holding the data.
       */
   gnssRinex& SolverRTKX2::postCompute( gnssRinex& gData )
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverRTKX2::postCompute()'
       ...
       *
       */
   SolverRTKX2& SolverRTKX2::setNEU( bool useNEU )
   {
   ...
   }  // End of method 'SolverRTKX2::setNEU()'
       ...
       */
   SolverRTKX2& SolverRTKX2::setCoordinatesModel( StochasticModel* pModel )
   {
   ...
   }  // End of method 'SolverRTKX2::setCoordinatesModel()'
       ...
       *                    ionospheric delays.
       */
   SolverRTKX2& SolverRTKX2::setIonosphericModel(StochasticModel* pModel)
   {
         // All coordinates will have the same model
      pIonoModel = pModel;
      return (*this);
       ...
       */
   double SolverRTKX2::getSolution(const TypeID& type) const
      throw(InvalidRequest)
   {
   ...
   }  // End of method 'SolverRTKX2::getSolution()'
       ...
       * @param type    TypeID of the solution we are looking for.
       */
   double SolverRTKX2::getFixedSolution(const TypeID& type) const
      throw(InvalidRequest)
   {
       ...
       */
   double SolverRTKX2::getVariance(const TypeID& type) const
      throw(InvalidRequest)
   {
   ...
   }  // End of method 'SolverRTKX2::getVariance()'
       ...
       * @param type    TypeID of the variance we are looking for.
       */
   double SolverRTKX2::getFixedVariance(const TypeID& type) const
      throw(InvalidRequest)
   {
   ...
   }  // End of method 'SolverRTKX2::getFixedVariance()'



      /** Return the CURRENT number of satellite.
       */
   int SolverRTKX2::getCurrentSatNumber() const
      throw(InvalidRequest)
   {
      ...
      /** Return the CURRENT number of satellite.
       */
   int SolverRTKX2::getAmbFixedNumWL() const
      throw(InvalidRequest)
   {
         // Return current fixed satellite number
      return numFixedBWL;
      ...
      /** Return the CURRENT number of satellite.
       */
   int SolverRTKX2::getAmbFixedNumL1() const
      throw(InvalidRequest)
   {
         // Return current fixed satellite number
      return numFixedBL1;
