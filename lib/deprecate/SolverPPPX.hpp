#pragma ident "$Id: SolverPPPX.hpp 2645 2011-06-08 03:23:24Z shjzhang $"
...
#ifndef GPSTK_SOLVERPPPX_HPP
#define GPSTK_SOLVERPPPX_HPP
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverPPPX object
       *   SolverPPPX pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPPX" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverPPPX" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPPX" object will
       ...
       *
       *
       * \warning "SolverPPPX" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPPX : public CodeKalmanSolver
   {
   public:
          ...
          * @param fixPos   If true, the receiver positoin will be fixed to
          *                 nominalPos, and will not be estimated.
          */
      SolverPPPX(bool useNEU = false, bool fixPos = false);
      ...
      virtual gnssRinex& Process(gnssRinex& gData)
          ...
          *
          */
      virtual SolverPPPX& setNEU( bool useNEU );


         /** Sets if the coordinate will be fixed as known.
          *
          * @param fixCoordinate    Boolean value 
          */
      virtual SolverPPPX& setFixCoordinate( bool fixPos );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverPPPX& setCoordinatesModel(StochasticModel* pModel);
   ...
   private:
         ...
         // Boolean to indicate whether fix the coordinate
      bool fixCoordinate;
      ...
      int numMeas;
         ...
         /// Number of equations for ionospheric delay constraints  
      int numIono;
      ...
      StochasticModel* pAmbiModelL1;
      StochasticModel* pAmbiModelL2; // for L2 
      ...
      virtual SolverPPPX& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverPPPX'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERPPPX_HPP
