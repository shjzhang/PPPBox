#pragma ident "$Id: SolverRTKX2.hpp 2645 2011-06-08 03:23:24Z shjzhang $"

/**
 * @file SolverRTKX2.hpp
 * Class to compute the PPP Solution with ionospheric estimation.
 */

#ifndef GPSTK_SOLVERRTKX2_HPP
#define GPSTK_SOLVERRTKX2_HPP
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverRTKX2 object
       *   SolverRTKX2 pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverRTKX2" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverRTKX2" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverRTKX2" object will
       ...
       *
       *
       * \warning "SolverRTKX2" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverRTKX2 : public CodeKalmanSolver
   {
   public:
      ...
      virtual void AmbiguityUpdate(Vector<double>& state,
          ...
          *
          */
      virtual SolverRTKX2& setNEU( bool useNEU );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverRTKX2& setCoordinatesModel(StochasticModel* pModel);
          ...
          *
          */
      virtual SolverRTKX2& setIonosphericModel(StochasticModel* pModel);
          ...
          */
      SolverRTKX2& setInitialTropVar(double variance)
      { initialTropVar = variance; return (*this); };
          ...
          * @param variance      Initial variance assigned to this variable.
          */
      SolverRTKX2& setInitialIonoVar(double variance)
      ...
      virtual std::vector<double> getTTSC() const
      {
          return ttsc;
      }
   ...
   private:
      ...
      PhaseAmbiguityModel* pAmbiModelWL;
      ...
      virtual SolverRTKX2& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverRTKX2'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERRTKX2_HPP
