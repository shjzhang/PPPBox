#pragma ident "$Id: SolverPPP2.hpp 2645 2011-06-08 03:23:24Z shjzhang $"
...
#ifndef GPSTK_SOLVERPPP2_HPP
#define GPSTK_SOLVERPPP2_HPP
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverPPP2 object
       *   SolverPPP2 pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPP2" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverPPP2" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPP2" object will
       ...
       *
       *
       * \warning "SolverPPP2" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPP2 : public CodeKalmanSolver
   {
   public:
          ...
          */
      SolverPPP2(bool useNEU = false, bool fixPos = false);
      ...
      virtual gnssRinex& Process(gnssRinex& gData)
          ...
          *
          */
      virtual SolverPPP2& setNEU( bool useNEU );
          ...
          */
      virtual SolverPPP2& setFixCoordinate( bool fixPos );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverPPP2& setCoordinatesModel(StochasticModel* pModel);
   ...
   private:
      ...
      virtual SolverPPP2& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverPPP2'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERPPP2_HPP
