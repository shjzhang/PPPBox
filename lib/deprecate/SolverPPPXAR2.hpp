#pragma ident "$Id: SolverPPPXAR2.hpp 2645 2011-06-08 03:23:24Z shjzhang $"

/**
 * @file SolverPPPXAR2.hpp
 * Class to compute the PPP Solution with ionospheric estimation.
 */

#ifndef GPSTK_SOLVERPPPXAR2_HPP
#define GPSTK_SOLVERPPPXAR2_HPP
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverPPPXAR2 object
       *   SolverPPPXAR2 pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPPXAR2" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverPPPXAR2" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPPXAR2" object will
       ...
       *
       *
       * \warning "SolverPPPXAR2" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPPXAR2 : public CodeKalmanSolver
   {
   public:
          ...
          */
      SolverPPPXAR2(bool useNEU = false);
      ...
      virtual void AmbiguityUpdate(Vector<double>& state,
          ...
          *
          */
      virtual SolverPPPXAR2& setNEU( bool useNEU );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverPPPXAR2& setCoordinatesModel(StochasticModel* pModel);
          ...
          */
      SolverPPPXAR2& setInitialTropVar(double variance)
      { initialTropVar = variance; return (*this); };
          ...
          * @param variance      Initial variance assigned to this variable.
          */
      SolverPPPXAR2& setInitialIonoVar(double variance)
      { initialIonoVar = variance; return (*this); };


         /** Sets if the LAMBDA ambiguity fixing method  will be used.
          *
          * @param useLAMBDA Boolean value  
          *
          */
      SolverPPPXAR2& setFixWithLambda(bool useLambda )
      { fixWithLambda = useLambda ; return (*this); };
      ...
      virtual int getCurrentSatNumber() const
         ...
         /** Return the CURRENT number of satellite.
          */
      virtual int getAmbFixedNumNL() const
         throw(InvalidRequest);
   ...
   private:
      ...
      bool firstTime;
         ...
         /// Boolean indicating if the lambda is used to fix ambiguities
      bool fixWithLambda;

      double initialTropVar;
      double initialIonoVar;
      ...
      StochasticModel* pClockStoModelWL;
      ...
      virtual SolverPPPXAR2& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverPPPXAR2'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERPPPXAR2_HPP
